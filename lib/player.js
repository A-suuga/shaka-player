 ...
 * @export
 */
shaka.Player = function(cozyInfo, video, opt_dependencyInjector) {
  shaka.util.FakeEventTarget.call(this);

  // TODO create an attach function
  /** @private {shaka.util.CozyUtils.CozyInfo} */
  this.cozyInfo_ = cozyInfo;
...
shaka.Player.prototype.loadManifest_ = async function(
    cozyInfo, manifestUri, opt_manifestParserFactory) {
...
shaka.Player.prototype.load = async function(manifestUri, opt_startTime,
  ...
  try {
    ...
    this.manifest_ = await this.loadManifest_(
      this.cozyInfo_, manifestUri, opt_manifestParserFactory);
