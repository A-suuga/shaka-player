 ...
 *
 * @param {function():!Promise.<!Array.<string>>} uris A function that creates the URIs of
...
shaka.media.InitSegmentReference = function(uris, startByte, endByte) {
  /** @type {function():!Promise.<!Array.<string>>} */
  this.getUris = uris;
 ...
 * @param {function():!Promise.<!Array.<string>>} uris
